...
感谢下面列出的贡献者，没有他们，hexo-theme-mxmatery 不会这么完美。
...
点击 [这里](https://gitee.com/mingxin142/mxhexoblog/repository/archive/master.zip) 下载 `master` 分支的最新稳定版的代码，解压缩后，将 `hexo-theme-mxmatery` 的文件夹复制到你 Hexo 的 `themes` 文件夹中即可。

当然你也可以在你的 `themes` 文件夹下使用 `Git clone` 命令来下载:

```bash
git clone https://github.com/mingxin142/mxhexoblog.git
```
...
修改 Hexo 根目录下的 `_config.yml` 的  `theme` 的值：`theme: hexo-theme-mxmatery`
...
![首页](https://pic.imgdb.cn/item/61cb1e362ab3f51d910cf328.png)

![文章](https://pic.imgdb.cn/item/61cb22f52ab3f51d911080cc.png)

![文章列表](https://pic.imgdb.cn/item/61cb23402ab3f51d9110b8a4.png)

![视听页面](https://pic.imgdb.cn/item/61cb24102ab3f51d91116c77.png)

![相册页面](https://pic.imgdb.cn/item/61cb24202ab3f51d911177ed.png)
